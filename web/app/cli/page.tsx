      ...
      <main className="max-w-3xl mx-auto px-6 py-16 flex flex-col gap-16 w-full">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-text-muted leading-relaxed">
            Run <code className="text-text-primary bg-surface border border-border rounded px-1.5 py-0.5 text-sm font-mono">npx prettypr</code> inside any repo. It reads your git history,
