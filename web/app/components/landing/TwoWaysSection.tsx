      ...
      <div className="max-w-5xl mx-auto flex flex-col gap-12">
        ...
        <div className="grid sm:grid-cols-2 gap-8">
          ...
          <div className="rounded-lg border border-border bg-background p-8 flex flex-col gap-4">
            ...
            <p className="text-sm text-text-muted leading-relaxed">
              Install nothing. Run <code className="font-mono text-xs bg-surface px-1 py-0.5 rounded">npx prettypr</code> in
...
{`npx prettypr              # fast
npx prettypr --diff       # richer output
npx prettypr --full       # best results
npx prettypr --out pr.md  # export to file`}
            </pre>
            <a
              href="/cli"
              className="self-start text-sm text-accent hover:text-accent-hover font-medium transition-colors"
